...
<html>
	...
	<body>
		<div class="sp-container">
			<h1 class="title"><span class="titlesale">Your </span><span class="titleproject">Profile</span></h1><br>
			<p class="greeting"> Hi, <?php echo $uname; echo"!"?></p>
			<p class="logout"><strong><a href="{{url('logout')}}">logout</a></strong></p>
			<br>
			<ul id="nav" class="tab">
				<li class="tab"><a class='active' href="{{url('profile')}}">Your Profile</a></li>
				<li class="tab"><a href="{{url('uploadPhoto')}}">Upload Photo</a></li>
